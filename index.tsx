...
const VocabView = () => {
    ...
    const cards = [
        ...
        { zh: "請問可以退稅嗎？", jp: "税金の払い戻しは受けられますか？" },
        { zh: "2位，沒有預約", jp: "2人いるんですが、まだ予約をしていません。" },
        { zh: "請問有推薦的餐點嗎？", jp: "何かオススメの料理はありますか？" },
        { zh: "請問有英文或中文菜單嗎？", jp: "すみません、台湾語か英語のメニューはありますか？" }
        { zh: "請問可以寄放行李嗎？", jp: "ここに荷物を預けてもいいですか？" },    
        { zh: "不好意思，請問廁所在哪裡？", jp: "すみません、トイレはどこですか？" }            
        { zh: "請問JR新宿站的中央線特急9、10月台怎麼走", jp: "すみません、JR新宿駅の中央線特急9番線と10番線への行き方を教えてください。" }
        { zh: "請問往富士急行線怎麼走?我要使用SUICA", jp: "富士急行線へはどうやって行けばいいですか？SUICAを使う必要があります。" },
        { zh: "我們從河口湖站刷SUICA到大月站，搭乘AZUSA到新宿", jp: "河口湖駅からSUICAで大月駅まで行き、あずさに乗って新宿まで行きました。" },    
    ];
