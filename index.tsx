  ...
  if (selectedDate === '07') {
    return (
      <>
        ...
        <div className="w-full h-40 rounded-xl overflow-hidden relative mb-8 shrink-0 shadow-sm group">
          <img 
            src="https://cdn.gaijinpot.com/app/uploads/sites/6/2016/09/Chuo-dori-Ginza-1024x683.jpg" 
            className="w-full h-full object-cover transform transition-transform duration-700 group-hover:scale-105" 
            style={{ objectPosition: 'center 40%' }}
            alt="Ginza Street"
          />
        ...
        <div className="space-y-0 relative">
          ...
          <TimelineItem time="10:20" dotColor="bg-amber-600">
             ...
             <div className="bg-amber-50 p-3 rounded-lg mt-2 border border-amber-100">
                 <div className="font-bold text-amber-800 text-xs mb-1">😋 必買外帶任務：PATISSERIE PAROLA</div>
                 <p className="text-xs text-gray-600 leading-relaxed">
                     前身為 TEN&。必吃「爆漿泡芙 (Choux à la crème)」，皮薄酥脆內餡濃郁！
          ...
          <TimelineItem time="11:30">
             ...
             <div className="mt-3 space-y-2">
                 ...
                 <div className="bg-white p-3 rounded-lg border border-gray-100 shadow-sm">
                     ...
                     <p className="text-xs text-gray-500">欣賞中庭裝置藝術 & 6F 蔦屋書店。</p>
                 </div>
                 <div className="bg-white p-3 rounded-lg border border-gray-100 shadow-sm">
                     <div className="flex justify-between items-center mb-1">
                     ...
                     <p className="text-xs text-gray-500">文具控必去，整棟的質感文具。</p>
                 </div>
                 <div className="bg-white p-3 rounded-lg border border-gray-100 shadow-sm">
                     <div className="flex justify-between items-center mb-1">
  ...
  if (selectedDate === '09') {
    return (
      <>
        ...
        <div className="w-full h-40 rounded-xl overflow-hidden relative mb-8 shrink-0 shadow-sm group">
          <img 
            src="https://images.unsplash.com/photo-1490806843957-31f4c9a91c65?q=80&w=2070&auto=format&fit=crop" 
            className="w-full h-full object-cover transform transition-transform duration-700 group-hover:scale-105" 
            style={{ objectPosition: 'center 40%' }}
            alt="Mount Fuji"
          />
